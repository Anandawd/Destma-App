...
import com.project.destma.network.service.DestinationService
import com.project.destma.network.service.UserService
...
class NetworkModule {
    ...
    @Provides
    fun provideDestinationService(retrofit: Retrofit): DestinationService = retrofit
